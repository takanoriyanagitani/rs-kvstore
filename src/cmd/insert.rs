...
use crate::rpc::{InsertRequest, Key, Val};
...
impl InsertReq {
    pub fn new<C>(g: InsertRequest, checker: &C) -> Result<Self, Status>
    where
        C: Checker,
    {
...
impl TryFrom<InsertRequest> for InsertReq {
    type Error = Status;
    fn try_from(g: InsertRequest) -> Result<Self, Self::Error> {
